...
from adversarial.utils.exceptions import UnspportedNum
...
def get_hopskipjump_instance(wrapped_models, norm, hopskipjump_params):
    '''
    '''
    adv_instance = {}
...
def generate_hopskipjump_result(
    ...
    adv_instance = get_hopskipjump_instance(wrapped_models, norm=norm, hopskipjump_params=hopskipjump_params)
